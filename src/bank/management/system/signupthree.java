...
JButton submit,cancel;
	...
	signupthree(String formno){
		...
		JLabel number =new JLabel("xxxx-xxxx-xxxx-4000");
		...
		cardDetail.setBounds(100,250,200,20);
		add(cardDetail);
		...
		c7 = new JCheckBox("I hearly detail are corredt to the best of the information. :");
		...
		submit.setBounds(210,620,100,30);
