...
public class Transaction extends JFrame implements ActionListener {
	JButton deposite,withdrawl,fastcash,balanceenquiry,pinchange,ministatement,exit;
	String pinnumber;
	Transaction(String pinnumber){
		...
		withdrawl = new JButton(" Cash Withdeawl");
		withdrawl.setBounds(355,320,150,30);
		withdrawl.addActionListener(this);
		image.add(withdrawl);
		
		 fastcash = new JButton(" Fast Deposite");
	...
	public void actionPerformed(ActionEvent ae) {
		if(ae.getSource()== exit) {
			...
			setVisible(false);
			new withdrol(pinnumber).setVisible(true);
